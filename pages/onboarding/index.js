...
const pageBg = {
  ...
  width: "100%",
  background:
    "radial-gradient(circle at top, rgba(59,130,246,0.25), transparent 55%), radial-gradient(circle at bottom, rgba(56,189,248,0.25), #020617 65%)",
  display: "flex",
  alignItems: "center",
...
export default function OnboardingWizard() {
  ...
  const [aiResult, setAiResult] = useState(null); // { ok, payload, raw, error, ... }
      ...
      <div style={shell}>
            ...
            {step === "upload" && (
              <div style={panel}>
                <div style={panelHeader}>
                  <div style={panelTitle}>Step 1 — Upload Vendor File</div>
        ...
        <div style={footer}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
            ...
            {step === "done" && (
              <button style={btnPrimary(false)} onClick={handleGoDashboard}>
                Go to dashboard
              </button>
            )}
          </div>
