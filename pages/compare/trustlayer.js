...
export default function CompareTrustLayer() {
  return (
    <>
      <Head>
        <title>TrustLayer Alternative for Property Managers | Vendor Risk Intelligence</title>
        <meta
          name="description"
      ...
      <main style={{ maxWidth: 1100, margin: "0 auto", padding: "120px 24px" }}>
        ...
        <p style={{ fontSize: 20, color: "#334155", maxWidth: 820 강조 }}>
          TrustLayer is a known insurance compliance tool. This platform takes a
        ...
        <section style={{ marginTop: 64 }}>
          ...
          <ul>
            <li>TrustLayer: demo‑led, automation‑first workflows</li>
            <li>This platform: self‑serve, visibility‑first control</li>
            <li>TrustLayer: vendor chasing out of the gate</li>
