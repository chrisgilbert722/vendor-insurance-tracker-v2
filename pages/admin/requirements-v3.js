  ...
  async function loadGroups() {
    ...
    try {
      ...
      try {
        ...
        throw new Error("Unexpected server response while loading groups.");
      }
  ...
  async function loadRulesForGroup(groupId) {
    ...
    try {
      ...
      try {
        ...
        throw new Error("Unexpected server response while loading rules.");
      }
  ...
  async function handleCreateGroup() {
    ...
    try {
      ...
      try {
        ...
        throw new Error("Unexpected server response while creating group.");
      }
  ...
  async function handleUpdateGroup(patch) {
    ...
    try {
      ...
      try {
        ...
        throw new Error("Unexpected server response while updating group.");
      }

      if (!res.ok || !json.ok) {
        throw new Error(json.error || "Group update failed.");
      }

      setToast({ open: true, type: "success", message: "Group updated." });
    } catch (err) {
      setToast({ open: true, type: "error", message: err.message });
      // reload to undo optimistic update on hard failure
      loadGroups();
    } finally {
      setSaving(false);
    }
  ...
  async function handleDeleteGroup(id) {
    ...
    try {
      ...
      try {
        ...
        throw new Error("Unexpected server response while deleting group.");
      }
  ...
  async function handleCreateRule() {
    ...
    try {
      ...
      try {
        ...
        throw new Error("Unexpected server response while creating rule.");
      }
  ...
  async function handleUpdateRule(ruleId, patch) {
    ...
    try {
      ...
      try {
        ...
        throw new Error("Unexpected server response while updating rule.");
      }
  ...
  async function handleDeleteRule(ruleId) {
    ...
    try {
      ...
      try {
        ...
        throw new Error("Unexpected server response while deleting rule.");
      }
  ...
  async function handleRunEngine() {
    try {
      ...
      try {
        ...
        throw new Error("Unexpected server response while running engine.");
      }
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <div
          style={{
            display: "grid",
            gridTemplateColumns:
              "minmax(0,1.2fr) minmax(0,1.8fr) minmax(0,1.4fr)",
            gap: 18,
            alignItems: "stretch",
          }}
        >
              ...
              <>
                ...
                >
                  {rules.length === 0 ? (
                    ...
                    >
                      No rules yet. Click <strong>+ New rule</strong> above to
